...
import { Store, Plus, Layers, ChevronRight } from 'lucide-react';
    ...
    <div className="h-full bg-surface overflow-y-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        <header className="flex justify-between items-end mb-10">
          <div>
            <h1 className="text-3xl md:text-5xl font-black text-[#0f172a] uppercase tracking-tighter mb-2 italic">DadStore</h1>
